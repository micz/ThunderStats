...
var miczThunderStatsTab = {
	...
	getTodayStats:function(identity_id){
		...
		//Get inbox num mails
		miczThunderStatsCore.db.getInboxMessagesTotal(identity_id,miczThunderStatsTab.worker.today_inboxnum);
		//Get inbox mails date spreading
		miczThunderStatsCore.db.getInboxMessagesDate(identity_id,miczThunderStatsTab.worker.yesterday_inboxnum);
