...
<template>
    ...
    <div class="square_item"><div class="list_heading_wrapper">
                    ...
                    <WidgetFoldersTags :chartDataTags="chartData_Tags" chart_id="chart_tags_yesterday" :chart_height="tags_chart_height" :is_loading="is_loading_tags_chart" />
    </div>
    <div class="square_item"><div class="list_heading_wrapper">
...
async function updateData() {
    ...
    // chart tags
    let tags_container_height = document.getElementById('chart_tags_yesterday').clientHeight;
